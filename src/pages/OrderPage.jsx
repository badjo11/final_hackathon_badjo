...
const OrderPage = () => {
  ...
  const schema = yup.object({
    number: yup
      ...
      .max(999999999999999, "Максимальное количество символов 16")
  ...
  const { cart, getAll, clearCountOfProducts } = useContext(productContext);
          ...
          >
            {({ handleSubmit, handleChange, values, touched, errors }) => (
              ...
              >
                ...
                <p>Общая сумма покупки: {cart ? cart.totalPrice : 0}</p>
                <Button variant="primary" type="submit">
                  Оплатить
                </Button>
              </Form>
